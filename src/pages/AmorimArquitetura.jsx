...
const portfolioTipologias = [
  {
    title: 'Gestão de Projetos',
    desc: 'Coordenação técnica completa de projetos arquitetônicos e de engenharia, do conceito à entrega.',
    projects: [
      { img: 'https://static.wixstatic.com/media/152459_6339ba323283427daa071eb7d16349ab~mv2.jpg/v1/fill/w_480,h_600,al_c,q_85,usm_0.66_1.00_0.01,enc_auto/2014.jpg', label: 'Gerenciamento da Nova Sede do CRC/PE', year: '2021', client: 'CRC/PE', location: 'Recife/PE' },
      { img: 'https://static.wixstatic.com/media/152459_306189bdcd0d41e583a79b549afcba9c~mv2.jpg/v1/fill/w_300,h_375,al_c,q_85,usm_0.66_1.00_0.01,enc_auto/CRC-PE%20-%20VISTA%2001.jpg', label: 'Projeto Nova Sede CRC/PE', year: '2017', client: 'CRC/PE', location: 'Recife/PE' },
      { img: 'https://static.wixstatic.com/media/152459_b214383a73d14514ad8901a5cb287041~mv2.png/v1/crop/x_359,y_0,w_583,h_731/fill/w_300,h_375,al_c,q_85,usm_0.66_1.00_0.01,enc_auto/cor.png', label: 'Residencial Parque de Exposições', year: '2024', client: 'Privado', location: 'Recife/PE' },
      { img: 'https://static.wixstatic.com/media/152459_84fd38ffd69849378852a469c196cf20~mv2.jpg/v1/fill/w_480,h_600,al_c,q_85,usm_0.66_1.00_0.01,enc_auto/RFRN.jpg', label: 'Nova Sede da Delegacia da Receita Federal', year: '2019', client: 'Receita Federal', location: 'Natal/RN' },
      { img: 'https://static.wixstatic.com/media/152459_04c2c92f8ef843218671d733881c4b64~mv2.png/v1/crop/x_530,y_0,w_861,h_1080/fill/w_480,h_600,al_c,q_85,usm_0.66_1.00_0.01,enc_auto/Largo%20do%20Monte.png', label: 'Requalificação Largo do Monte', year: '2017', client: 'Prefeitura do Recife', location: 'Recife/PE' },
      { img: 'https://static.wixstatic.com/media/152459_0a72b01d9aa9414cae7ab49644a3dcd2~mv2.jpg/v1/fill/w_480,h_600,al_c,q_85,usm_0.66_1.00_0.01,enc_auto/parquedasesculturas-1.jpg', label: 'Atrativos Turísticos do Recife', year: '2015', client: 'SETUR/PE', location: 'Recife/PE' },
    ],
  },
  {
    title: 'Gestão e Fiscalização de Obras',
    desc: 'Acompanhamento técnico rigoroso garantindo qualidade, prazo e custo nas obras.',
    projects: [
      { img: 'https://static.wixstatic.com/media/152459_bcf3588cf83b4d30afb4dd255a9c3e07~mv2.jpg/v1/fill/w_480,h_600,al_c,q_85,usm_0.66_1.00_0.01,enc_auto/DSC00299_JPG.jpg', label: 'Capela São João Batista do Brum', year: '2017', client: 'Exército Brasileiro', location: 'Recife/PE' },
      { img: 'https://static.wixstatic.com/media/152459_0dedafe2eeda4698981281984bcf0c99~mv2.jpg/v1/fill/w_480,h_600,al_c,q_85,usm_0.66_1.00_0.01,enc_auto/Basilica%20do%20Carmo%20_JPG.jpg', label: 'Restauração Basílica do Carmo', year: '2019', client: 'FUNDARPE', location: 'Olinda/PE' },
      { img: 'https://static.wixstatic.com/media/152459_eba2191949b14057a6b1fc5693f2ab8c~mv2.jpg/v1/crop/x_322,y_0,w_957,h_1200/fill/w_480,h_600,al_c,q_85,usm_0.66_1.00_0.01,enc_auto/taatro11.jpg', label: 'Cine Teatro Quartel do Derby', year: '2014', client: 'Governo PE', location: 'Recife/PE' },
      { img: 'https://static.wixstatic.com/media/152459_f4a82f2ec8e84ae19863af18f9c440e8~mv2.jpg/v1/crop/x_290,y_0,w_861,h_1080/fill/w_480,h_600,al_c,q_85,usm_0.66_1.00_0.01,enc_auto/teleferico%20recife06.jpg', label: 'Teleférico Parque Dois Irmãos', year: '2015', client: 'SETUR/PE', location: 'Recife/PE' },
      { img: 'https://static.wixstatic.com/media/152459_19c8ac599d664aeab9bfc55afa4a5639~mv2.jpg/v1/crop/x_665,y_0,w_1977,h_2480/fill/w_300,h_375,al_c,q_85,usm_0.66_1.00_0.01,enc_auto/FORUM%20justi%C3%A7a%20federal.jpg', label: 'Fórum Des. Neves Filho', year: '2015', client: 'JFPE', location: 'Recife/PE' },
    ],
  },
  {
    title: 'Gestão da Manutenção',
    desc: 'Planejamento e controle da manutenção predial para preservar e valorizar patrimônios.',
    projects: [
      { img: 'https://static.wixstatic.com/media/152459_15e60566f08a4fcf828b0c37630ce2ed~mv2.jpg/v1/fill/w_480,h_600,al_c,q_85,usm_0.66_1.00_0.01,enc_auto/sol.jpg', label: 'Usina Solar CRC/PE', year: '2023', client: 'CRC/PE', location: 'Recife/PE' },
      { img: 'https://static.wixstatic.com/media/152459_e7a542e59257490a8661700ab41915fa~mv2.jpg/v1/crop/x_77,y_0,w_265,h_332/fill/w_300,h_375,al_c,q_85,usm_0.66_1.00_0.01,enc_auto/blog-engenho_edited.jpg', label: 'Restauração Engenho São João', year: '2012', client: 'IPHAN', location: 'Pernambuco' },
      { img: 'https://static.wixstatic.com/media/152459_1920e747843046e8b52ca5306d85e91d~mv2.jpg/v1/fill/w_300,h_375,al_c,q_85,usm_0.66_1.00_0.01,enc_auto/P1010034_JPG.jpg', label: 'Restauração Engenho Monjope', year: '2011', client: 'IPHAN', location: 'Pernambuco' },
    ],
  },
];
...
function PortfolioCarousel({ projects }) {
  ...
  return (
    <div className="relative rounded-2xl overflow-hidden shadow-md border border-slate-200 bg-slate-900" style={{ height: 320 }}>
      <img src={p.img} alt={p.label} className="w-full h-full object-cover opacity-80 transition-opacity duration-500" />
      <div className="absolute inset-0 bg-gradient-to-t from-slate-900/90 via-slate-900/30 to-transparent flex flex-col justify-end p-6">
        <span className="text-xs font-bold text-blue-300 uppercase tracking-widest mb-1">{p.year} · {p.client}</span>
        <p className="text-white text-lg font-bold leading-tight">{p.label}</p>
        <p className="text-slate-300 text-sm mt-1">{p.location}</p>
      </div>
      {/* Nav dots */}
      ...
      <button onClick={next} className="absolute right-3 top-1/2 -translate-y-1/2 w-8 h-8 bg-black/40 hover:bg-black/60 text-white rounded-full flex items-center justify-center transition-colors">
          ...
          {portfolioTipologias.map((tip, i) => (
            <div key={i} className="flex flex-col gap-4">
              <div>
                ...
                <p className="text-slate-500 text-sm mt-1">{tip.desc}</p>
              </div>
              <PortfolioCarousel projects={tip.projects} />
            </div>
          ))}
        </div>
      </div>
