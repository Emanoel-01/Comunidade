...
import {
  ...
  Building, Laptop, Settings, Scale, Brain, Palette, Volume2 } from
'lucide-react';
      ...
      <section className="py-20 bg-white border-b border-slate-200">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-14">
            ...
            <p className="text-slate-500 max-w-3xl mx-auto text-base leading-relaxed">O mercado não paga mais por "clínicos gerais". A Construção 4.0 exige um perfil raro e altamente bem pago: o Líder de Nicho. Aquele que domina a técnica profunda, sabe fechar contratos de alto valor e lidera equipes com maestria. Descubra os 3 Pilares exclusivos do nosso ecossistema que vão transformá-lo na maior autoridade da sua área.
