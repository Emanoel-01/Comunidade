      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-slate-400 text-base sm:text-lg max-w-3xl mx-auto leading-relaxed mb-6">
            Não basta ter o diploma se não tem a oportunidade. Nossos alunos são inseridos ativamente no mercado, fecham contratos reais e publicam artigos durante a formação. <strong>Veja os resultados de quem já está conosco:</strong>
          </p>
          <button
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-14">
            ...
            <p className="text-slate-500 max-w-3xl mx-auto text-base leading-relaxed">
              O mercado não paga mais por "clínicos gerais". A Construção 4.0 exige um perfil raro e altamente bem pago: o <strong>Líder de Nicho</strong>. Aquele que domina a técnica profunda, sabe fechar contratos de alto valor e lidera equipes com maestria. Descubra os 3 Pilares exclusivos do nosso ecossistema que vão transformá-lo na maior autoridade da sua área.
            </p>
          </div>
